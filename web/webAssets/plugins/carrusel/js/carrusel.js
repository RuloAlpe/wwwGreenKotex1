...
(function (Core) {
    var Slider = (function () {
        function Slider() {
            ...
            this.isAuto = true;
            this.working = false;
            this.dom.wrapper = $('.page-carrusel');
        ...
        Slider.prototype.process = function () {
            ...
            // this.dom.current.addClass('active');
            setTimeout(function () {
...
document.addEventListener('DOMContentLoaded', function () {
    var imgLoad0 = imagesLoaded( '.page-carrusel', { background: true }, function() {
      console.log('page-carrusel loaded');
    });
